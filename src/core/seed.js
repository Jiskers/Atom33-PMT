...
export const seedFiles = {
  f_ideas: {
    name: "quest ideas", view: "board",
    settings: { grid: true, tone: "cork", zoom: 1 },
    modules: [
      { id: "m1", type: "note", x: 90, y: 70, rot: -1.6, tint: 0, data: { text: "what if reloading costs HP? risk economy everywhere" } },
      { id: "m2", type: "mechanic", x: 360, y: 120, rot: 1.1, data: { name: "Dust storms", hook: "Storm rolls in every 8 min — visibility drops, loot doubles.", status: 1 } },
      { id: "m3", type: "checklist", x: 680, y: 80, rot: -0.8, data: { title: "vertical slice must-haves", hideDone: false, items: [
        { t: "one full quest chain", done: true },
        { t: "storm cycle working", done: false },
        { t: "save / load", done: false },
      ] } },
      { id: "m4", type: "ref", x: 140, y: 330, rot: 1.8, data: { caption: "mood: rust & teal", colors: ["#B34233", "#2E6E6A", "#E8C87A"] } },
      { id: "m5", type: "note", x: 420, y: 380, rot: 0.9, tint: 1, data: { text: "playtest note: tutorial is 4 min too long. cut the lore dump." } },
    ],
  },
  f_sprint: {
    name: "sprint 3", view: "kanban", settings: {},
    columns: [
  ...
  f_budget: {
    name: "scope budget", view: "sheet", settings: {},
    cells: {
  ...
  f_html: {
    name: "index.html", view: "code", settings: {},
    code: `<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  f_css: {
    name: "style.css", view: "code", settings: {},
    code: `body {
...
.storm {
  ...
  f_ref: {
    name: "palette refs", view: "board",
    settings: { grid: false, tone: "ink", zoom: 1 },
    modules: [
      { id: "m9", type: "ref", x: 100, y: 90, rot: -1.2, data: { caption: "desert dusk", colors: ["#5A2E3C", "#C46A4A", "#EFD9A7"] } },
    ],
  },
  f_devlog: { name: "devlog drafts", view: "board", settings: { grid: true, tone: "slate", zoom: 1 }, modules: [] },
};
