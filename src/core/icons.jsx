...
export const I = {
  ...
  search: "M2.5 6.5a4 4 0 108 0 4 4 0 10-8 0zM9.5 9.5L14 14",
  people: "M5.5 7A2 2 0 105.5 3a2 2 0 000 4zM1.5 13c0-2.2 1.7-4 4-4s4 1.8 4 4M11 3.3a2 2 0 010 3.4M14.5 13c0-1.9-1.2-3.5-2.8-3.9",
  reports: "M2 13.5h12M4 13.5V9M7.5 13.5V4M11 13.5V7",
  ...
  pin: "M8 2.3a2.3 2.3 0 100 4.6 2.3 2.3 0 000-4.6zM8 6.9V13.7M5.3 13.7h5.4",
  paperclip: "M4.5 8.5l4.8-4.8a2 2 0 112.8 2.8L6.8 12.8a3.3 3.3 0 01-4.6-4.6L7.8 2.6",
};
